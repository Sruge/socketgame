...
class EnemyHealthbar {
  ...
  void updateRect(int maxH, int h, double x, double y) {
    _maxHealth = maxH;
    _health = h;
    double greenSize = (_health / _maxHealth) * screenSize.width * 0.05;
    double redSize =
        ((_maxHealth - _health) / _maxHealth) * screenSize.width * 0.05;
    _healthbarGreen = Rect.fromLTWH(x, y - _barHeight, greenSize, _barHeight);
    _healthbarRed =
        Rect.fromLTWH(x + greenSize, y - _barHeight, redSize, _barHeight);
    _healthbarBorder = Rect.fromLTWH(
